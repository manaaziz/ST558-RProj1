...
All that being said, I pulled the 2017/2018 Vegas Golden Knights roster from the `roster` endpoint. Then, since I knew exactly what I wanted in my data, I created two loop to pull two data sets about the players out of the `players` endpoint in the Stats API.  
